...
export default function AdminCalendarPage() {
  ...
  async function handleCreateEvent(e: React.FormEvent) {
    ...
    if (!headline.trim() || !description.trim() || !selectedDate) {
      alert("Please fill in all required fields and select a date");
      return;
    }

    const event_date = selectedDate;
    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-yellow-100">
      ...
      <div className="bg-white border-b-4 border-yellow-400 p-6 shadow-sm">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <h1 className="text-2xl font-bold text-gray-900">WASP Events Calendar</h1>
          <Link
            href="/admin"
              ...
              >
                ...
                {selectedDate && (
                  <div className="text-sm font-semibold text-gray-700 bg-blue-50 p-2 rounded">
                    📅 Event date: {new Date(selectedDate).toLocaleDateString("default", { weekday: "short", month: "short", day: "numeric" })}
                  </div>
                )}
