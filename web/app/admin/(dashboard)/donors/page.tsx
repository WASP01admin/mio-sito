...
export default async function AdminDonorsPage({
  ...
  let query = supabaseAdmin
    .from("donors")
    .select(
      "id, code, name, city, country, address, lat, lng, email, phone, website"
    );
  ...
  return (
    <div>
      <div className="flex justify-between items-start gap-6">
        <div>
          <h1 className="text-xl font-bold">Donors Database</h1>
          <p className="mt-1 text-sm text-gray-500">
            <span className="font-semibold text-gray-900">{filteredCount || 0} total</span> donors
            {country && country !== "all"
      ...
      <div className="mt-3">
        <AssociationsTable associations={donors as any} />
      </div>
