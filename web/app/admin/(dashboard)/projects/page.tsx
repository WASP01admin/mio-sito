    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-white border-b-4 border-yellow-400 p-6 shadow-sm">
        <div className="max-w-5xl mx-auto flex justify-between items-center">
          <h1 className="text-2xl font-bold text-gray-900">WASP Projects & Fundraising</h1>
        ...
        {loading ? (
          ...
          <div className="space-y-4 mb-8">
            {sortedProjects.map((project) => {
              ...
              return (
                <div key={project.id} className="flex bg-white rounded-lg shadow hover:shadow-lg transition-shadow">
                  {/* Left Panel - Metadata */}
