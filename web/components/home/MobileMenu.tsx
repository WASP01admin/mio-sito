...
export default function MobileMenu() {
  ...
  const navLinks: Array<{ key: string; href: string }> = [
    { key: "home", href: "/" },
    { key: "mapOrganizations", href: "#" },
    { key: "mapAnimalFriends", href: "#" },
    { key: "chat", href: "#" },
    { key: "eventsCalendar", href: "#" },
    { key: "newsNetwork", href: "#" },
  ];
          ...
          {navLinks.map((link) =>
            link.href === "/" ? (
              <Link
                ...
                href="/"
                onClick={() => setIsOpen(false)}
                className="text-lg font-medium tracking-wide hover:text-wasp-yellow"
              >
                {t(`nav.${link.key}`)}
              </Link>
            ) : (
