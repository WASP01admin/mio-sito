...
/**
 * UPDATE USA COMPLETE BY CITY
 * Geocode cities and place all associations on map
 * This processes the remaining USA batch (USA0206 onwards)
 */
...
async function updateUSAComplete() {
  console.log('\n╔═══════════════════════════════════════════╗');
  console.log('║  UPDATE USA COMPLETE BY CITY              ║');
  console.log('║  WASP IS FAIR AND DEMOCRATIC              ║');
  console.log('║  (USA0206 onwards - 1,356 records)        ║');
  console.log('╚═══════════════════════════════════════════╝\n');

  // Read the CSV
  const csvPath = 'usa_cities_complete.csv';
  ...
  console.log(`Found ${records.length} USA associations\n`);
  ...
  if (updates.length > 0) {
    ...
    console.log('\n╔═══════════════════════════════════════════╗');
    console.log('║  USA COMPLETE BATCH DONE ✓               ║');
    console.log('╚═══════════════════════════════════════════╝\n');
